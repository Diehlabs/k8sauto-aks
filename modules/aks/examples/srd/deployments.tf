...
provider "helm" {
  kubernetes {
    host                   = module.aks_ci.host
    username               = module.aks_ci.cluster_username
    password               = module.aks_ci.cluster_password
    client_certificate     = module.aks_ci.client_certificate
    client_key             = module.aks_ci.client_key
    cluster_ca_certificate = module.aks_ci.cluster_ca_certificate
  }
  debug = true
}
